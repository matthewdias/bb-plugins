  ...
  ({ className, variant, size, asChild = false, type, ...props }, ref) => {
    ...
    return (
      <Comp
        ...
        ref={ref}
        // A bare <button> defaults to type="submit". These render inside the
        // composer's form, so every click was submitting the draft — expanding
        // the follow-up banner sent the message. Only set it on a real button:
        // with asChild, Slot forwards props to an arbitrary child.
